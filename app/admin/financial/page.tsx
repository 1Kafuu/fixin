...
const serviceRevenue = [
  { service: "Screen Replacement", count: 245, revenue: 61250000, percentage: 32 },
...
const transactions = [
  { id: "TXN-001", customer: "Ahmad Rizki", service: "Screen Replacement", amount: 250000, status: "Completed" as TransactionStatus, date: "2024-01-21", method: "GoPay" },
  { id: "TXN-002", customer: "Siti Nurhaliza", service: "Virus Removal", amount: 150000, status: "Completed" as TransactionStatus, date: "2024-01-21", method: "OVO" },
  { id: "TXN-003", customer: "Budi Santoso", service: "Keyboard Replacement", amount: 180000, status: "Pending" as TransactionStatus, date: "2024-01-21", method: "Bank Transfer" },
  { id: "TXN-004", customer: "Dewi Kartika", service: "RAM Upgrade", amount: 220000, status: "Completed" as TransactionStatus, date: "2024-01-20", method: "GoPay" },
  { id: "TXN-005", customer: "Eko Prasetyo", service: "Data Recovery", amount: 350000, status: "Failed" as TransactionStatus, date: "2024-01-20", method: "Credit Card" },
  { id: "TXN-006", customer: "Farhan Ramadhan", service: "Windows Installation", amount: 200000, status: "Completed" as TransactionStatus, date: "2024-01-20", method: "OVO" },
  { id: "TXN-007", customer: "Lisa Permata", service: "Laptop Cleaning", amount: 120000, status: "Refunded" as TransactionStatus, date: "2024-01-19", method: "GoPay" },
  { id: "TXN-008", customer: "Maya Sari", service: "Antivirus Installation", amount: 75000, status: "Completed" as TransactionStatus, date: "2024-01-19", method: "DANA" },
  { id: "TXN-009", customer: "Rudi Hermawan", service: "Screen Replacement", amount: 250000, status: "Completed" as TransactionStatus, date: "2024-01-19", method: "Bank Transfer" },
  { id: "TXN-010", customer: "Ani Wijaya", service: "Virus Removal", amount: 150000, status: "Completed" as TransactionStatus, date: "2024-01-18", method: "GoPay" },
];
    ...
    <div className="p-6 space-y-6">
              ...
              <div key={service.service}>
                <div className="mb-1 flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <span className="text-sm font-medium">{formatShortCurrency(service.revenue)}</span>
                    <span className="ml-2 text-xs text-muted-foreground">({service.count} orders)</span>
                  </div>
                </div>
                <div className="h-3 overflow-hidden rounded-full bg-muted">
                  <div className="h-full rounded-full bg-gradient-to-r from-blue-500 to-blue-400 transition-all" style={{ width: `${service.percentage}%` }} />
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-3">
            {paymentMethods.map((method) => (
              <div key={method.method} className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <p className="text-sm font-medium">{formatShortCurrency(method.amount)}</p>
      ...
      <div className="rounded-xl border border-border bg-card shadow-sm">
        <div className="flex flex-col gap-4 border-b border-border p-4 sm:flex-row">
          <SearchInput value={search} onChange={(v) => { setSearch(v); setCurrentPage(1); }} placeholder="Search transactions..." className="flex-1" />
          <FilterTabs
            tabs={[
              { value: "All", label: "All" },
            ...
            onTabChange={(v) => { setStatusFilter(v as TransactionStatus | "All"); setCurrentPage(1); }}
          />
        </div>
                ...
                <tr key={txn.id} className="transition-colors hover:bg-muted/30">
                  ...
                  <td className="px-4 py-3">
                    <span className="inline-flex items-center gap-1 rounded-full bg-blue-50 px-2 py-0.5 text-xs font-medium text-blue-700">
                      <Wallet className="h-3 w-3" />{txn.method}
                    </span>
                  </td>
                  <td className="whitespace-nowrap px-4 py-3 text-right text-sm font-medium">{formatCurrency(txn.amount)}</td>
