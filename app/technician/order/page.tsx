...
const statusColors: Record<string, string> = {
  "Menunggu Teknisi": "bg-amber-50",
  "Menuju Lokasi": "bg-blue-50",
  "Sedang Diperbaiki": "bg-violet-50",
  "Menunggu Persetujuan": "bg-orange-50",
...
export default function OrderListPage() {
  ...
  return (
    <div className="p-4 sm:p-6">
      {/* Page Header */}
      <div className="mb-6">
        <h1 className="text-xl sm:text-2xl font-semibold text-foreground">Pesanan Servis</h1>
        ...
        {MOCK_ORDERS.map((order) => {
          ...
          return (
            <Link
              ...
              className="rounded-xl border border-border bg-card p-5 shadow-sm hover:shadow-md hover:border-blue-200 transition-all group"
            >
              {/* Header */}
              ...
              <div className="space-y-2 mb-4">
                <h3 className="font-semibold text-foreground">{order.serviceType}</h3>
